...
(function (app) {
    class Rectangulo {
        constructor() {
            ...
            this.rectangleContainer = bodyRectangulo
                .append("div")
        ...
        calcularperimetro() {
            const lado1 = Number(document.getElementById("perilado1").value);
            const lado2 = Number(document.getElementById("perilado2").value);
            if (!isNaN(lado1) && !isNaN(lado2)) {
